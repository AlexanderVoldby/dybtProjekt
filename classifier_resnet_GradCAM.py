...
def main():
    ...
    model_path = '/Users/fredmac/Documents/DTU-FredMac/Deep/dybtProjekt/models/resnet18_finetuned_models.pth'  
    ...
    # ===========================
    # 5.6 Select Images for Visualization
    # ===========================
    ...
    # ===========================
    # 5.7 Apply Grad-CAM and Visualize
    # ===========================
    ...
    gradcam_real_dir = os.path.join(gradcam_base_dir, 'real_resnet_models')
    gradcam_synthetic_dir = os.path.join(gradcam_base_dir, 'synthetic_resnet_models')

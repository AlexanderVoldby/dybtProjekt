...
# ===========================
# 3. Define Helper Function to Split Dataset
# ===========================
def split_dataset(dataset, val_ratio=0.1):
    ...
    Returns:
        ...
        val_subset (Subset): Validation subset.
    """
...
def main():
    ...
    data_dir = '/Users/fredmac/Documents/DTU-FredMac/Deep/dybtProjekt/data/stanford_cars/'  # Update this path
    ...
    for dir_path in [real_train_dir, synthetic_train_dir, real_test_dir, synthetic_test_dir]:
    ...
    full_train_dataset = ImageDataset(real_dir=real_train_dir, 
                                      synthetic_dir=synthetic_train_dir, 
                                      transform=data_transforms['train'])

    # Split the dataset into training and validation sets
    train_subset, val_subset = split_dataset(full_train_dataset, val_ratio=validation_split)
    ...
    # ===========================
    save_dir = '/Users/fredmac/Documents/DTU-FredMac/Deep/dybtProjekt/models/'  # Update this path
    os.makedirs(save_dir, exist_ok=True)
    model_path = os.path.join(save_dir, 'resnet18_finetuned_images.pth')
